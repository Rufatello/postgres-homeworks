...
SELECT order_id, customer_id, freight, ship_country FROM orders WHERE ship_country LIKE 'P%' ORDER  BY freight LIMIT 10
...
SELECT country, COUNT(company_name) FROM suppliers GROUP BY country ORDER BY COUNT(*) DESC;
